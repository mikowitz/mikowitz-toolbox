...
Based on an idea by John Trupiano ("linktext":http://www.github.com/jtrupiano/johns-toolbox), 
...
The code for git output is from Thomas Mayfield ("linktext":http://github.com/thegreatape/dot-files)
